...
" automatically close brackets without plugin
inoremap " ""<left>
inoremap ' ''<left>
inoremap ( ()<left>
inoremap [ []<left>
...
Plug 'ap/vim-css-color' " display hex color codes directly inside vim
Plug 'majutsushi/tagbar' " outline for vim
